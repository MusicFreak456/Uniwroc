...
static void signal_handler(int signo) {
  // gdybyśmy użyli longjump zamiast odpowiednika z przedrostkiem sig
  // to w tym miejscu handler miałby zablokowany sygnał który obsługuje
  // i ta blokada nie zostałaby zdjęta, bo skoczylibyśmy do readnum
