...
(define formula (conj (disj (neg 'x) 'y) (disj 'y 'z)))
...
(define vals (gen-vals (free-vars formula)))

(define first-val (car vals))
...
(falsifiable-eval? formula)

(define taut (disj (neg 'x) 'x))

taut

(falsifiable-eval? taut)
